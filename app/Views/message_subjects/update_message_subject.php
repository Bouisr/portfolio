<section class="message-subjects-section bg-light" id="messagesubjects" style="padding-top: 5rem; padding-bottom: 5rem">
    ...
    <div class="container px-4 px-lg-5 text-center">
        ...
        <h2 class="row justify-content-center text-black mb-4">Mettre à jour un sujet de message</h2>



        <?= form_open('messagesubject/updatemessagesubject', 'class="" id=""'); ?>
