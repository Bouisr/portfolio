        ...
        <?php foreach ($projectList as $project) : ?>
            ...
            <div class="container px-4 px-lg-5" style="padding-bottom: 5rem;">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center text-center">
                    ...
                    <div class="col-xl-8 col-lg-7" style="object-fit: cover; border: solid; border-width: 0.5px;">
                        ...
                        <?= '<img class="img-fluid mb-lg-0" src="'
                    ...
                    <figcaption class="overlay">
                            ...
                            <a class="btn btn-primary" href="<?= base_url('assets/uploads/'.$production['pdf_production']); ?>">Consulter</a>
